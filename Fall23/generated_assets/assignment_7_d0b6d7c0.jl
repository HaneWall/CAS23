...
# ╔═╡ 62059ca8-1f35-43af-b1ca-96b06f7f2d14
begin
	using CairoMakie
	using Symbolics
	using Elliptic
...
# ╔═╡ 1a0e65c8-9457-11ee-21a6-1975a91ef2d5
html"""
...
# ╔═╡ 3f274bdb-bfb7-4e1c-8341-8710798e50de
md"""
...
# ╔═╡ 7f72bc24-fd14-4e83-aaf0-904ffad225ed
md"""
**Abgabe bis**: 14.12.2023 - 1800 Uhr auf StudIP im "Aufgaben"-Menü der Vorlesung.
"""

# ╔═╡ 94405f38-6260-41e8-8dad-3809ede85f20
md"""
!!! correct "Person"
...
# ╔═╡ 9438fe16-a16a-4b6b-b07f-3ac758e81f0d
student = Dict(
	"name" => "Max Mustermann", 
	"fach" => "Studiumsfach",
	"matrikelnr" => "1234")

# ╔═╡ 5afde6df-626a-46f4-aa36-30cf4a3c19d0
md"""
**Autor der Abgabe**: $(student["name"]), **MNR**: $(student["matrikelnr"]), **Fach**: $(student["fach"])
"""

# ╔═╡ 71c6ba09-db34-45c5-b7be-d38c331f35ab
md"""
## Aufgabe 1 - Numerische Integration - Trapezregel
"""

# ╔═╡ 34dfca28-7c01-4bd8-81b3-1016f4f8bdcd
md"""
Für eine Funktion $f : [a, b] \to \mathbb{R}$ und $n \in \mathbb{N}$ wird die Trapezsumme 

$T(n) = \frac{h}{2} \left(f(a)  + f(b) + 2 \sum_{k=1}^{n-1}f(a + k\cdot h)\right)$
gebildet, die eien Näherung für das Integral $\int_{a}^{b}f(x)dx$ darstellt.
"""

# ╔═╡ 877396a6-a2e3-4c6b-9479-143eda8c48fc
md"""
!!! warning "1a)"
	Schreiben Sie eine Funktion, die $f,a, b$ und $n$ einliest und $T(n)$ berechnet. 
"""

# ╔═╡ 4e758111-1fe3-4835-a941-7a170f797c7d
#missing code

# ╔═╡ 1f1bfc46-a835-4e10-b660-e1263b4ecd38
md"""
!!! warning "1b)" 
	Testen Sie Ihre Funktion anhand von $f:[0,1] \to \mathbb{R}$, wobei $f(x)=x^2$ und $n=1, 2, \ldots, 10$. Vergleichen Sie Ihre Ergebnnisse mit dem analytischen Ergebnis von $\int_{0}^{1}x^2 dx$. Was passiert, wenn $n$ immer größer wird? 
"""

# ╔═╡ 623ae2d9-768b-4946-87d2-850f6cb9dd84
let
#missing code
end

# ╔═╡ 5ca08b03-d1fc-4df2-85ca-d6d4095f3acf
md"""
## Aufgabe 2 - Numerische Intregration - numerische Fehler
"""

# ╔═╡ 4fae1dd1-04fa-455d-af41-7252f5f473c3
md"""
 Betrachten Sie das Integral 

$\int_0^5 \sqrt{1+\cos^2(x)}dx$.
"""

# ╔═╡ 9568e2fc-c46b-4cc0-b5df-bea2974e35b3
md"""
!!! warning "2a)"
	Nutzen Sie die Funktion aus Aufgabe 1, die das gegebene Integral näherungsweise mit Hilfe der Trapezsumme mit $n$ Teilintervallen berechnet. Berechnen Sie damit die Trapezsumme als Näherung des Integrals für $n=10,11,12,13,...,99,100$ und erstellen Sie ein entsprechendes 1D-Array als Rückgabe.
"""

# ╔═╡ 66476dd7-7cad-47f2-925d-78bd4a1b6dd6
let
# missing code
end

# ╔═╡ 590ad969-0b4b-4cd5-81dc-63eaff634e9a
md"""
!!! warning "2b)"
	Erstellen Sie zudem ein Array, welches die absoluten Fehler der Approximationen aus Teilaufgabe a) im Vergleich zum analytischen Ergebnis `analytic` setzt (siehe unten). Plotten Sie die absoluten Fehler als eine Funktion von $n$. Wie hängt der absolute Fehler von $n$ ab?
"""

# ╔═╡ 8065a782-9633-4a52-bcd4-3a973d125889
analytic = sqrt(2) *(2*Elliptic.E(1/2) + Elliptic.E(5-π, 1/2))

# ╔═╡ f1310102-16dc-433d-a9f2-7760853ec7d8
let
# missing code
end

# ╔═╡ 7e0de3d7-bc35-4d39-918a-fbbc0966b900
md"""
## Aufgabe 3 - Lineare Gleichungssysteme 
"""

# ╔═╡ ec74413a-36c6-44b4-8627-9df33ae7c3fc
md"""
!!! warning "3a)" 
	...
	mittels `Symbolics.solve_for(..)`. 
"""

# ╔═╡ a9553d6e-e548-42b6-9f42-519cd653524b
let
@syms x y
# missing code
end

# ╔═╡ e5e18348-4a9b-4eb7-9c44-62e37501969b
md"""
# (Haus)aufgabe 4 - Lineares Gleichungssystem
"""

# ╔═╡ 08611a2d-a6e9-4be5-b947-443de81adeab
md"""
!!! warning "4)"
	Herr Matheses hat drei Kinder: Primus, Sekunda und Tertius. 
	- Primus sagt: Wenn Sekunda dreimal so alt ist, wie ich es jetzt bin, dann sind Sekunda und ich zusammen genau 21 mal älter als Tertius jetzt.
	- Sekunda sagt: Ich bin so alt wie Primus war, als Tertius gerade geboren wurde.
	- Tertius sagt: Ich bin in einem Jahr genau ein Drittel mal so alt, wie Primus dann ist. 
	Stellen Sie für jede Aussage eine entsprechende Gleichung auf und ermitteln Sie dann das Alter der drei Kinder, indem Sie das entsprechende Gleichungssystem mit `Symbolics.solve_for(..)` lösen. 
"""

# ╔═╡ 1065d82b-d42d-43eb-af20-9aaa64e6e362
let
#missing code
end

# ╔═╡ 34f3f5d7-c582-47ad-bbbf-325cfa2d2216
md"""
# (Haus)aufgabe 5 - Schaltjahre
"""

# ╔═╡ 37f5125d-3ebf-4d2c-b430-56a2d97d8fe0
md"""
!!! warning "5)"
	Julius Caesar stellte seiner Zeit fest, dass eine Sonnenumrundung der Erde irgendetwas zwischen 365 und 366 Tagen in Anspruch nimmt. Mit der Einführung des julianischen Kalenders 45 v.Chr. berücksichtigte er dies, in dem er alle 4 Jahre (All jene, welche sich durch 4 teilen lassen) ein sogenanntes Schaltjahr einfügte.
	Da diese Regellung noch zu ungenau war (Eine Sonnenumrundung dauert genau 365,24219 Tage), wurden mit der Einführung des gregorianischen Kalenders (1582) folgende Regeln ergänzt
	1. Lässt sich das Jahr durch 4 teilen, so ist es ein Schaltjahr.
	2. Lässt es sich außerdem durch 100 teilen, handelt es sich jedoch um ein Gemeinjahr, bestehend aus 365 Tagen.
	3. Lässt sich ein Jahr auch noch durch 400 teilen, besteht das Jahr wieder aus 366 Tagen und ist ein Schaltjahr.

	Diese Regelung ist bis heute gültig. Schreiben Sie eine Funktion “leap_year”, welche für ein eingegebenes Jahr ermittelt, ob es ein Schaltjahr war, bzw. sein wird. Testen Sie ihre Prozedur an folgenden Jahren: 2018, 2016, 2000, 1900, 2100, 1500, 1203, 1204, 100 v.Chr. Beachten Sie, dass die Regelungen sich über die Jahrhunderte verändert haben. Stellen Sie sicher, dass die Ausgaben auf der Abgabe vorhanden sind.
"""

# ╔═╡ edf5f891-ba5f-434d-9c7f-3b966a942b8c
let
#missing code
end
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "f7ab807023c47e3e4cf8ee174507268ecdc7a949"
