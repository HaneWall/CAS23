...
md"""
!!! hint "Sidefacts"
	Das `Makie` framework wird tatächlich vom deutchen "Federal Ministry of Research und Education" gefördert und wird unter anderem vom deutschen Wetterdienst benutzt. Das Wort Maki-e kommt aus den Japanischen und heißt "besprenkeltes Bild".
"""
...
let
Leinwand = Figure(size = (1200, 800), backgroundcolor=:moccasin, fontsize=23)
Leinwand
end
...
fig = Figure(size = (1200,800), fontsize= 25)
...
manifest_format = "2.0"
project_hash = "2fbf5215957c9d50eda99828d6987fc213c47ffb"
