...
md"""
**Abgabe bis**: 25.01.2024 - 1800 Uhr auf StudIP im "Aufgaben"-Menü der Vorlesung.
"""
...
md"""
Ähnlich wie in Beispiel 2 in der Vorlesung vom 15.01.2024 
von Holger Kösters wird mit dem folgenden MAPLE-Code 
ein Näherungswert für die Wahrscheinlichkeit für das Ereignis "zweimal gleiche Augenzahl" bestimmt
...
md"""
!!! warning "1a)"
	Übersetzen Sie den Code in Julia mit Hilfe des Befehls `rand`.
"""
...
md"""
!!! warning "1b)"
	Da hier nur die relative Häufigkeit nach s=10000 Schritten berechnet werden soll, ist eine Zwischenspeicherung von Simulationsergebnissen nicht erforderlich. Ändern Sie ihr Programm aus Teil a) ao ab, dass es ohne die Verwendung von Matrizen auskommt.   
"""
...
md"""
Das folgende Programm führt uns zu den Anfängen der modernen Stochastik zurück; es soll nämlich im 17. Jahrhundert des Glücksspieler $\textit{Chevalier de M\'er\'e}$ beschäftigt und zu einem Briefwechsel zwischen ihm und dem Mathematiker
$\textit{Blaise Pascal}$ geführt haben.
...
md"""
## Aufgabe 3: Gefälschte Hausaufgabe 
"""

# ╔═╡ 5830fd4e-cb08-485a-a75d-cbd8d098dc09
md"""
Wir betrachten Beispiel 5 aus der Vorlesung vom 15.01.2024 von Holger Kösters und wollen die Echtheit der Liste dieses Mal aber anhand der Anzahl der Wechsel zwischen Nullen und Einsen oder Einsen und Nullen überprüfen. 
"""
...
md"""
!!! warning "4c)"
	Testen Sie ihre Funktion mit verschiedenen Eingabewerten. Für $n = R = 1000$ soll der Sachverhalt abschließend geeignet graphisch dargestellt und der Näherungswert für $\pi$ mit genau drei Nachkommastellen zurückgegeben werden Ergänzen Sie
	entsprechend der benötigten Ausgabewerte Ihre Funktion.
"""
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "84d84ecdfc793feebb52cf4d9b1a0b6805cfc7be"
