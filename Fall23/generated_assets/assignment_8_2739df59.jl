...
# ╔═╡ b61f9d92-d02b-11f0-8f2f-e3dc6ed6c8a6
begin
    using CairoMakie
    using Symbolics
    using LinearAlgebra
...
# ╔═╡ e0029d78-d4fe-4a27-ab73-b7d60d6f7400
html"""
...
# ╔═╡ fd9bbd54-c628-4b0f-b5e5-01b303a54d98
md"""
...
# ╔═╡ eac1983c-f426-42b0-a7ec-6c3092b4c353
md"""
...
# ╔═╡ 5a623aad-a777-4b41-95d3-1250d9a6c271
md"""
> #### Aufgabe 1a)
>> Loesen Sie das Gleichungssystem handschriftlich.
"""

# ╔═╡ 7ec65310-5c7f-4899-9fa1-e885f4232363
md"""
missing text
"""

# ╔═╡ d10ce657-2c71-4b2b-af5c-030fa0b0241b
md"""
> #### Aufgabe 1b)
>> Loesen Sie das System durch symbolische Berechnung mithilfe Ihrer Programmiersprache.
"""

# ╔═╡ 0d3c7333-0d91-4576-8c63-c1b25b70796c
let
    #missing code
end

# ╔═╡ 969121d0-f5a5-42f8-9b3d-1713a096c2e1
md"""
> #### Aufgabe 1c)
...
# ╔═╡ b1b82263-a79f-404f-8c3c-3121ee93aa8a
let
    # missing code 
end

# ╔═╡ 23720dc2-9f49-49ac-9bb4-a12e77d165a7
md"""
## Teil 2 - Loesen linearer Gleichungssysteme
"""

# ╔═╡ 06d92ee0-b667-49ba-a911-93c72b36daf0
md"""
> #### Preliminaries
...
# ╔═╡ a75ffa04-c3d4-4ae9-bb2b-70e4f3dea1f2
md"""
> #### Aufgabe 2a)
>> Stellen Sie die entsprechende Koeffizientenmatrix und erweiterte Koeffizientenmatrix auf. 
"""

# ╔═╡ ee6d1a86-c605-44d8-a83e-7ac3354b25af
let
    # missing code
end

# ╔═╡ 08f4c827-cdf6-4606-af7c-e812b4858d01
md"""
> #### Aufgabe 2b)
...
# ╔═╡ 052d8166-3a3a-41c9-91c8-6bf7d79148f4
let
    # missing 
end

# ╔═╡ 5b173cf9-6899-4df4-bc95-470b2e952758
md"""
> #### Aufgabe 2c)
>> Loesen Sie das Gleichungssystem unter Verwendung eines geeigneten Befehls.
"""

# ╔═╡ 9bc9c34c-08c1-4483-938a-7b5f2e77b089
let
    # missing 
end

# ╔═╡ bd5eeaa3-d2ba-41d9-b5ae-d288e745f7b6
md"""
## Teil 3 - Lineare Transformationen
"""

# ╔═╡ 8d3676b2-2f70-417d-87ce-0c369e924206
md"""
> #### Aufgabe 3a)
...
# ╔═╡ 8f249219-ac59-4b06-93de-1e463e78aaf6
let
    #missing
end

# ╔═╡ 39a9588a-32e7-4762-9deb-acf4cb803ce6
md"""
> #### Aufgabe 3b)
...
# ╔═╡ 8696ac0b-ab2b-478b-a924-92791fa579d3
md"""
(i).
...
# ╔═╡ 578748b6-9048-485e-8512-cc8bff7f3bc0
let
    # missing
end

# ╔═╡ 03f9f7ae-402d-45cc-929d-9f20edb0c7b4
md"""
(ii).
...
# ╔═╡ 799f6106-4872-47ca-8cac-98013796289a
let
    # missing
end

# ╔═╡ 2f11feb3-5ff4-43ae-97bd-ce7b7773da2c
md"""
(iii).
...
# ╔═╡ 212aec9d-2d2d-473c-95e3-765a846d9ba2
let
    # missing
end

# ╔═╡ 0c9c2ccf-5b12-4d59-a7c9-50b034865153
md"""
# (Haus)aufgabe 4 - Verkettungen linearer Abbildungen
"""

# ╔═╡ d309c2f3-6575-4fa1-8710-87dba231a86a
md"""
!!! warning "4a)"
	Berechnen Sie mit Hilfe des in Aufgabe 3 erstellten Programms die hintereinander ausgeführten Abbildungen $y = Bx$ und $z = Ay$, wobei 
...
# ╔═╡ 0efd2e0b-d48e-4ec1-a056-14288767ae32
let
    #missing code
end

# ╔═╡ 04533c80-0b03-40e1-a764-4ba631ac7441
md"""
!!! warning "4b)"
...
# ╔═╡ 131f35df-a70d-4158-89d9-67a84f813c68
let
    #missing code
end

# ╔═╡ d901c001-099e-48b6-a852-dbb6ae37998d
md"""
!!! warning "Zusatz 4c)"
	Beweisen Sie das in b) verwendete Assoziativgesetz $(AB)x = A(Bx)$.
"""

# ╔═╡ 81a0cca2-b236-4a87-a5c6-f9e281762bfd
md"""
#text
"""
...
manifest_format = "2.0"
project_hash = "34ab11719fd8ce3c8b6dc0046ae2cf6ee2e08a2f"
