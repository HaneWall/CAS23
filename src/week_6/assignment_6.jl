...
#> description = "Abgabe 05.12.2024, 23:59 Uhr"
...
# ╔═╡ 63756426-6e7b-4361-8e97-c50df3bd38c6
md"""
**Abgabe bis**: siehe StudIP im "Aufgaben"-Menü der Vorlesung.
"""

# ╔═╡ f49ed3d3-4567-4125-a3b3-a08114263b0a
md"""
# Lernziele
> - Bisektionsmethode zur Nullstellenbestimmung 
> - Anwendung des Taylor-Polynoms zur Approximation von Funktionen
"""
...
md"""
## Teil 1: Wiederholung Ableitungen
"""
...
md"""
> #### Aufgabe 2b)
>> Plotten Sie die Funktion `f` mit dem `CairoMakie` Package und markieren Sie die berechnete Nullstelle.
"""
...
md"""
# (Haus)aufgabe 3 - Taylor
"""

# ╔═╡ 2240955a-15eb-42be-912a-d1a7258fbcf6
md"""
> #### Preliminaries
>> Approximieren Sie die Kosinus-Funktion $\cos(x)$ mit einem Taylor-Polynom $p_{n}(x)$ in einer Umgebung von $x = 0$, d.h. es soll gelten $p_{n}(x) \approx \cos(x)$.
"""

# ╔═╡ 9993d28b-9fe3-45a9-b8f5-f365f7b1e690
md"""
!!! warning "3a)"
	Bestimmen Sie, wie in der Vorlesung besprochen, das Taylor-Polynom $p_{n}(x)$ zur Approximation der Kosinus-Funktion bis zur Ordnung $n$, welche den größten Exponenten des Polynoms in $x$ angibt.
"""
...
md"""
!!! warning "3b)"
	Implementieren Sie die Berechnung des Taylor-Polynoms der Kosinus-Funktion als Funktion von $x$ sowie der Ordnung $n$.
"""
...
md"""
!!! warning "3c)"
    Testen Sie Ihr Programm fuer die Werte $x \in \lbrace{0, \pi/2, \pi \rbrace}$ und $n=20$.
"""
...
md"""
!!! warning "3d)"
    Plotten Sie in einem gemeinsamen Koordinatensystem die Approximationen $p_n(x)$, wobei $n=4, 6, 10$, sowie $f(x) = \cos(x)$.  Nutzen Sie dazu ein äquidistantes Gitter $x\in [-5,5]$ mit 100 Stützstellen. 
"""
