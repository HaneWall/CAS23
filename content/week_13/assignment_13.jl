...
md"""
## 1. Aufgabe: Mandelbrot-Menge
"""

# ╔═╡ 12b2542f-f0d6-4d17-9957-8c91f9648c4e
md"""Die Mandelbrot-Menge wird beschrieben durch alle komplexen Zahlen 
$c=x+\mathrm{i} y$, für die die rekursiv definierte Folge 
$z_{n+1}=z_n^2+c$ mit $z_0=0$ beschränkt bleibt. Als Schranke kann 
man $|z_i|<2$ setzen."""

# ╔═╡ 2e2ad7ea-ce8c-4ee3-bc6e-dd32ddf8c837
md"""
!!! warning "1a)"
	Schreiben Sie eine Funktion `mandelbrot`, die für 
	gegebene $x,y$ die Folgenglieder $z_i$ bestimmt. Zählen Sie 
	hierbei die Iterationsschritte, solange die Iterierten die gegebene 
	Schranke nicht überschreiten, mit einer maximalen Iterationsanzahl 
	von  $50$. Nutzen Sie als Rückgabewert die gezählten Iterationsschritte. 
"""

# ╔═╡ 6023be98-dbf6-4020-92d2-d2ed78e2fbdb
md"""
!!! hint "Komplexe Zahlen in Julia"
	In Julia können komplexe Zahlen durch `z = a + imb` erzeugt werden. Dabei ist a der Realteil und b der Imaginärteil. Nach der Initialiseirung können wir auf `a` durch `z.re` und auf `b` durch `z.im` zurückgreifen.
"""
...
md"""
!!! warning "1b)"
	Nutzen Sie geignete plot-Befehle, um die Mandelbrotmenge 
	für die Intervalle $x,y \in [-2,0.7]\times[-1.2,1.2]$ und 
	$x,y \in [-0.83561,-0.78523]\times[0.15559,0.19343]$ darzustellen. Machen 
	Sie sich hierfür noch einmal mit Makie und 3D-Grafiken vertraut. Nutzen Sie ein 150 $\times$ 150 Gitter. 
"""
...
md"""
## 2. Aufgabe: Attraktorgebiete des Newton-Verfahrens im Komplexen
"""

# ╔═╡ b8134c42-652f-4b0f-af05-947a4b9a7930
md"""
Die Nullstellen der Funktion $f:\mathbb{C}\rightarrow \mathbb{C}$ mit $f(z)=z^3-1$
sind durch $z^{(0)}=1$, $z^{(1)}=e^{\frac{2\pi i}{3}}$ und
$z^{(2)}=e^{-\frac{2\pi i}{3}}$ gegeben.
"""
...
md"""
!!! warning "2b)"
	Testen Sie Ihre Funktion mit den Startwerten $z_0=\frac{1}{2}$,
	$z_0=\frac{1}{2}+i$ und $z_0=\frac{1}{2}-i$.
"""
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "237fabc41bf92f08f4b133bba721b9d20fb2533a"
