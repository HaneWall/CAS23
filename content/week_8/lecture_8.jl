...
md"""
Eine Möglichkeit besteht darin, lineare Systeme symbolisch mit dem Symbolics Package zu lösen.
"""

# ╔═╡ 5c7d738b-22a3-41a9-9787-e689808f2f0f
let
@syms x y
Symbolics.solve_for([3*x + 5*y ~ 7, x-y ~ 4], [x, y])
end

# ╔═╡ 8d472a46-c352-4ae3-a93f-aa2ae7dc631d
md"""
Eine andere Möglichekeit besteht darin, das LinearAlgebra Paket zu nutzen. Bzw. die Matrixnotattion auszunutzen.
"""
...
md"""
Wir basteln uns eine kleine Hilfsfunktion, welche inplace ("!") die Zeilen `i` und `j` vertauscht.
"""

# ╔═╡ 47558d5f-7bf1-441a-be8c-0eef8e9ee65a
function swaprow!(M, i::Integer, j::Integer)
	for k in axes(M, 2) #iterates over 2nd dimension (columns)
        idata = M[i,k]
        M[i,k] = M[j,k]
        M[j,k] = idata
	end
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "a3fd7041f6bed2feaeb5b2b7a8b1f7e9bd896c9d"
