...
md"""
Um die Koeffizienten als 1D-Array zu bekommen, nutzt man:
"""
...
md"""
Man kann unsere Approximation bzw. Reihe `z1` nun auch an anderen Stellen auswerten:
"""
...
md"""
ab. Um eine Taylorreihe der Exponentialfunktion an $t_0=1$ zu entwickeln, nutzen wir einfach:
"""
...
md"""
Taylorreihe entwickelt an $x_0 = 1$:
"""
...
x_arr_neg = collect(-2:0.05:0)
x_arr_pos = collect(0:0.05:2)
ax = Axis(fig[1, 1])
lines!(ax, x_arr_all, g.(x_arr_all), label=L"f(x)")
lines!(ax, x_arr_pos, tl1.(x_arr_pos .- 1), linestyle=:dash, linewidth=4, label=L"Taylor, x_0=1")
lines!(ax, x_arr_neg, tl2.(x_arr_neg .+ 1), linestyle=:dash, linewidth=4, label=L"Taylor, x_0=-1")
axislegend()
fig
end
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "08ba6e086b18862c11942deee602a81f2f194b8c"
