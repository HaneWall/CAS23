...
# ╔═╡ a07b251a-afe6-11ee-2f9d-abf39ef15348
begin
	using CairoMakie
	using LinearAlgebra
	using PlutoUI
...
# ╔═╡ 5f3c00fb-688e-4fb7-9e2b-9c46ab007aca
html"""
...
md"""
**Abgabe bis**: 18.01.2024 - 1800 Uhr auf StudIP im "Aufgaben"-Menü der Vorlesung.
"""
...
# ╔═╡ 3d5dff95-76f1-4a5c-9226-452573244a78
md"""
## 1. Aufgabe: WWW und Page-Rank-Algorithmus von Google
"""

# ╔═╡ a35962e7-8633-4e54-a776-8e757706ad60
PlutoUI.Resource("https://i.imgur.com/53h366Z.png")

# ╔═╡ 6cdc8a1c-62df-4496-9565-461d50feb508
md"""
!!! warning "1a)"
...
# ╔═╡ 5d5180ab-1ae2-46e8-8ecc-705af6d4f0a4
md"""
Text
"""

# ╔═╡ c16e123d-8c7b-4125-ac9a-b7f5c1372153
md"""
!!! warning "1b)"
...
# ╔═╡ 61593587-436c-48cd-b4f1-a14e80fcfe2c
begin 
#missing code
end

# ╔═╡ 3e102a02-420b-48d6-b7a7-692ffd29b1e6
md"""
!!! warning "1c)"
	Berechnen Sie mit MATLAB die Bewertungen der einzelnen Webseiten und geben Sie die Indizes der Webseiten geordnet nach ihrerer Bewertung aus. Der Index der Webseite mit der höchsten Bewertung soll zuerst ausgegeben werden.
"""

# ╔═╡ ea8e1676-98b2-4668-a719-38bddf91a36d
begin 
#missing code
end
...
md"""
## Aufgabe 2: Fortsetzung - WWW und Page-Rank-Algorithmus von Google
"""

# ╔═╡ 1216a6ac-531a-469a-b786-dca0155af440
md"""
Die Bewertungsmatrix $A$ des in der Vorlesung behandelten Page-Rank-Algorithmus ist eine sogenannte stochastische Matrix, bei der die Summe der Elemente jeder Spalte jeweils 1 ergibt. Diese stochastischen Matrizen haben die Eigenschaft, dass die iterative Berechnung von

$x^{(k+1)} = Ax^{(k)} \quad \text{mit gegebenen Startvektor} \qquad x^{(0)} \neq 0$

für große $k$ gegen den zum Eigenwert 1 (welches der betragsgrößte Eigenwert ist) zugehörigen Eigenvektor, d.h. gegen die Lösung der Gleichung x = Ax konvergiert. Dies soll im Folgenden getestet werden.
"""

# ╔═╡ ab0e9aa4-38d7-4007-ab77-8f40a8fd7040
md"""
!!! warning "2a)"
	Betrachten Sie das in Aufgabe 1 dargestellte Beispiel eines kleinen Netzes mit 8 Webseiten und verwenden Sie die dort berechnete Link-Bewertungsmatrix $A = A_{ij} \in \mathbb{R}^{8\times8}$ für die beschriebene Iteration. Verwenden Sie den Startvektor $x^{(0)} = (1/8, ..., 1/8)^{T}$ und schreiben Sie eine Julia-Funktion, welche basierend auf der Konnektivitätsmatrix den Relevanzvektor $x$ des in der Vorlesung behandelten Page-Rank-Algorithmus mit $k_{max} = 50$ Iterationen berechnet. Normieren Sie zusätzlich nach jedem Iterationsschritt den berechneten Vektor $x^{(k)}$ und vergleichen Sie die Ergebnisse.
"""

# ╔═╡ 1d8bec86-f38b-41c7-a888-c48db03ae3c0
begin 
#missing code
end

# ╔═╡ 89a8d050-0c25-4e44-a01f-00cae288b4ef
md"""
!!! warning "2b)"
	Ändern Sie Teil a) so ab, dass die Iterationen durchgeführt werden, bis die Euklidische Norm $\sqrt{\sum_{i=1}^8 d_i^2}$ der Differenz $d=(d_1, \ldots, d_8)^{T} = x^{(k+1)}-x^{(k)}$ zweier aufeinanderfolgender Iteratioen kleiner als $10^{-3}$ ist. 
"""

# ╔═╡ 233344c5-28e8-4581-8ebe-90a94978c2fb
begin 
#missing code
end
...
md"""
!!! danger "2c)*"
	Stellen Sie die Euklidische Norm des Unterschieds zur mit dem Backslashoperator `\` bestimmten Lösung in Abhängigekeit des Iterationsindex $k$ grafisch dar. Wählen Sie für die Anzahl der Iteratioen eine sinnvolle Größe.
"""
...
md"""
!!! warning "3a)"
	Stellen Sie die Konnektivitätsmatrix und die Link-Bewertungsmatrix zum gegebenen Netz auf. 
"""
...
md"""
!!! warning "3b)"
	Berechnen Sie die Relevanzliste iterativ. Hierfür sie die geforderte Genauigkeit der Funktion $eps=0.001$. Geben Sie die Anzahl der notwendigen Schritte aus, bis diese Genauigkeit erreicht ist. 
"""
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "f2b0494a5495e2daef1a9f7cd30324a169e60543"
