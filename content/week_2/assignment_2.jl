...
begin 
	...
	using Colors, ColorVectorSpace, ImageShow, FileIO, ImageIO # Für die Bildermagie im exklusiven Zusatz
end
...
md"""
**Abgabe bis**: 02.11.2023 - 1800 Uhr auf StudIP im "Aufgaben"-Menü der Vorlesung.
"""

# ╔═╡ 34de661e-ad7f-4762-a7e9-1b401eee4144
md"""
!!! correct "Person"
...
md"""
## Aufgabe 1 - Wiederholung Plotten mit Makie
"""
...
md"""
!!! warning "2 b)"
	Löschen Sie aus den 1D-Array `[1, 2, 3, 4, 3, 2, 3, 4, 5, 4, 3, 4, 5, 6]` die Elemente heraus, die mehr als zweimal vorhanden sind.
"""
...
md"""
!!! warning "2 c)"
	Erstellen Sie ein 2D-Array mit zwei Zeilen, bei der die erste Zeile dem 1D-Array aus 2 b) entspricht. Die Elemente der zweiten Zeile sollen den Indizes des 1D-Arrays aus 2 b) entsprechen. Beispielsweise würde das zu erstellende 2D-Array für das 1D-Array [4, 8, 1, 0] wie folgt aussehen:  
...
md"""
# (Haus)aufgabe 3 - Fibonacci-Folge
"""

# ╔═╡ 650017e8-e9d4-4b1e-85c0-cb98fa5b321c
md"""
Die Fibonacci-Folge ist definiert durch $a_0 \coloneqq 1, a_1 \coloneqq 2, a_{k+2} \coloneqq a_{k+1} + a_{k}$ mit $k \in \mathbb{N}= \lbrace 1, 2, 3, 4 \ldots \rbrace$
"""
...
md"""
!!! warning "3 b)"
	Berechnen Sie nun alle Folgenglieder bis $k = 20$ mit einer `for` Schleife und entscheiden Sie, welche Schleifenart für diese Berechnung geeigneter ist.
"""
...
md"""
# Exklusiver Zusatz/Für die Interessierten - Bilder sind Arrays
"""

# ╔═╡ faa1902d-9c18-4826-8aa1-91ec93a21e69
md"""
Alles was jetzt noch kommt ist exklusiver Zusatz und nur in unserer Gruppe. Ihr müsst hiervon nichts bearbeiten, aber eventuell fördert es die Intuition von Indizes.
"""
...
brahe_url = download("https://upload.wikimedia.org/wikipedia/commons/archive/2/2b/20180405083300%21Tycho_Brahe.JPG?uselang=de") 

# ╔═╡ f74848d4-7eb7-4885-8b8b-3e194a53f6e5
brahe_pic = load(brahe_url)

# ╔═╡ 1efac9f1-db7c-4239-bb76-5d8774980a02
md"""
Wir können nun dieses Bild wie ein 2D-Array behandeln. Das Bild ist nichts weiter als eine Tabelle voller Zeilen und Spalten, dessen Elemente Farbpixel/Farben sind. Lasst uns zunächst mit dem Befehl `size` nachschauen wieviel Zeilen und Spalten unser Bild hat.
"""

# ╔═╡ 36bd804d-fe39-43ea-a1ef-800243ddb3cc
size(brahe_pic)
...
let 
brahe_pic = load(brahe_url)
brahe_pic[420, 80] = RGB(1.0, 0.0, 0.0)
brahe_pic
end 
...
let 
brahe_pic = load(brahe_url)
brahe_pic[1:end, 70:80] .= RGB(1.0, 0.0, 0.0) 
brahe_pic
end 
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "b83ad3e9cc694c3726951c179f538fe6b32a0750"
