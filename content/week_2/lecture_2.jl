...
Am Beispiel der Folge $a_{n+1} = \frac{1}{2}\left(a_n + \frac{2}{a_n}\right)$ zur Berechnung von $\sqrt{2}$
"""
...
ylims!(ax, [0.9, 1.6]) #y-Bereich der auf den Koordinatensystem gezeigt werden soll
...
# ╔═╡ 5813a64f-2447-43bd-ab51-30c7002ffbd1
md"""
...
md"""
Das folgende Programm berechnet die Abstände zwischen den Folgengliedern. Von der symmetrsichen Abstandsmatrix wird nur die Hälfte berechnet.
"""
